...
# Construct a BigQuery client object.
    ...
    job_config = bigquery.LoadJobConfig(
        #write_disposition = bigquery.WriteDisposition.WRITE_APPEND by default
        schema=[
...
if __name__ == "__main__":
    load_csv_to_big_query(file_bucket_url="gs://terraform-basics-458014-movielens/movie_lens/tags.csv",
